...
const local = @import("../gateway/local.zig");
const local_models = @import("../gateway/local_models.zig");
const local_permission_reviewer = @import("../gateway/local_permission_reviewer.zig");
...
pub const native = provider_set.Set{
    ...
    .local = .{
        .presentation = provider_catalog.find(.local),
        .auth_strategy = .local,
        .agent_stream = local.agent_stream_provider,
        .cli_model_catalog = local_models.cli_model_catalog_provider,
        .model_catalog = local_models.model_catalog_provider,
        .permission_reviewer = local_permission_reviewer.provider,
    },
};
